package com.abaya.picacho.biz.account.service.impl;
...
public class AccountServiceImpl implements AccountService {
    ...
    @Override
    public List<Account> queryAllValidAccount() {
        return this.queryAllAccount().stream().filter(account -> account.getState() == CommonState.valid).collect(Collectors.toList());
    }
}
